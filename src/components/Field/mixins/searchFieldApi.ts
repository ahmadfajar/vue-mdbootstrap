            ...
            withDirectives(
              h('input', {
                ...
                'onUpdate:modelValue': (value: string) => {
                  ...
                  if (value.length >= (thisProps.minlength as number)) {
                ...
                onBlur: (e: Event) =>
                  useOnFieldBlurred(emit, e, isFocused, thisProps.disabled as boolean),
                onFocus: (e: Event) =>
                  useOnFieldFocused(emit, e, isFocused, thisProps.disabled as boolean),
              }),
