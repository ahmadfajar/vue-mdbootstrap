                ...
                h(
                    'div',
                    {
                        ...
                        onClick: (event: UIEvent) => {
                            ...
                            Helper.defer(() => {
                                pickerData.hueSliderThumb.value?.classList.remove(
                                    'move-transition'
                                );
                            }, 100);
                        },
                    ...
                    h(
                        'div',
                        {
                            ...
                            onClick: (event: UIEvent) => {
                                ...
                                Helper.defer(() => {
                                    pickerData.alphaSliderThumb.value?.classList.remove(
                                        'move-transition'
                                    );
                                }, 100);
                            },
        ...
        h(
            ...
            [
                h('div', {
                    ...
                    onMousedown: () =>
                        document.addEventListener('mousemove', colorMarkerMoveHandler),
                    onTouchstart: () =>
...
export function useMoveColorMarker(
    ...
    const x = pointer.clientX - pickerData.colorAreaRect.left;
    const y = pointer.clientY - pickerData.colorAreaRect.top;
