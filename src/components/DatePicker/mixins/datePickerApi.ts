...
import type { ComputedRef, Prop, Ref, VNode } from 'vue';
...
function createCalendarNavButton(
  ...
  return h(BsButton, {
    ...
    readonly: disabled as unknown as Prop<boolean>,
...
function createCalendarDayButton(
  ...
  return h(
    BsButton,
    {
      ...
      mode: 'icon' as Prop<TButtonMode>,
      readonly: props.disabled as unknown as Prop<boolean>,
      color: (!today.hasSame(data.value, 'day') && !selected
        ? props.calendarButton || 'secondary'
        : props.selectedColor) as Prop<TButtonColor | string>,
      class: isOutlined ? `${cssPrefix}btn-today` : undefined,
      flat: (!today.hasSame(data.value, 'day') && !selected) as unknown as Prop<boolean>,
      outlined: isOutlined as unknown as Prop<boolean>,
  ...
  return h(
    BsButton,
    {
      ...
      color: (!today.hasSame(data.value, unit) && !selected
        ? props.calendarButton || 'secondary'
        : props.selectedColor) as Prop<TButtonColor | string>,
      flat: (!today.hasSame(data.value, unit) && !selected) as unknown as Prop<boolean>,
      outlined: isOutlined as unknown as Prop<boolean>,
      pill: false as unknown as Prop<boolean>,
      rounded: true as unknown as Prop<boolean>,
      onClick: (evt: Event) => {
        preventEventTarget(evt);
        clickHandler();
      },
...
function createPickerTimeButton(
  ...
  return h(
    BsButton,
    {
      readonly: isDisabled as unknown as Prop<boolean>,
      color: color as Prop<string>,
      flat: true as unknown as Prop<boolean>,
      pill: false as unknown as Prop<boolean>,
      rounded: true as unknown as Prop<boolean>,
        ...
        [
          props.headerPanel === true
            ? h(BsDatePickerHeader, {
                color: props.headerColor as Prop<string>,
                enableTime: showTime.value as unknown as Prop<boolean>,
                displayMode: currentView.value as Prop<TDateTimePickerMode>,
                pickerMode: pickerMode.value as Prop<TDateTimePickerMode>,
                landscape: props.landscape as unknown as Prop<boolean>,
          ...
          h(
            ...
            [
              useRenderTransition(
                ...
                [
                  currentView.value !== DatePickerConst.TIME
                    ? h<TBsDatePickerNav>(BsDatePickerNav, {
                        buttonColor: (props.buttonColor || 'secondary') as Prop<string>,
                        displayMode: currentView.value as Prop<TDateTimePickerMode>,
              ...
              useRenderTransition(
                ...
                [
                  currentView.value === DatePickerConst.DATE
                    ? h<TBsDatePickerCalendar>(BsDatePickerDays, {
                        locale: locale.value as Prop<string>,
                        modelValue: thisValue as Prop<Date>,
                        disabled: props.readonly as unknown as Prop<boolean>,
                        calendarDate: calendarValue.value as Prop<Date>,
                        calendarButton: (props.buttonColor || 'secondary') as Prop<string>,
                  ...
                  currentView.value === DatePickerConst.MONTH
                    ? h<TBsDatePickerCalendar>(BsDatePickerMonths, {
                        locale: locale.value as Prop<string>,
                        modelValue: thisValue as Prop<Date>,
                        disabled: props.readonly as unknown as Prop<boolean>,
                        calendarDate: calendarValue.value as Prop<Date>,
                  ...
                  currentView.value === DatePickerConst.YEAR
                    ? h<TBsDatePickerCalendar>(BsDatePickerYears, {
                        locale: locale.value as Prop<string>,
                        modelValue: thisValue as Prop<Date>,
                        disabled: props.readonly as unknown as Prop<boolean>,
                        calendarDate: calendarValue.value as Prop<Date>,
                    ...
                    : undefined,
                  currentView.value === DatePickerConst.TIME
                    ? h<TBsDatePickerTimes>(BsDatePickerTimes, {
                        locale: locale.value as Prop<string>,
                        modelValue: thisValue as Prop<Date>,
                        disabled: props.readonly as unknown as Prop<boolean>,
                        calendarButton: (props.buttonColor || 'secondary') as Prop<string>,
