 ...
 *
 * @param color The HSLA color value.
 * @return The RGBA color value. `Red`, `Green`, and `Blue` as number in range [0..255],
 ...
 * @return The HSL color value. `Hue` as degrees [0..360], `Saturation` and `Lightness` as number in range [0..100].
 */
...
/**
 * Parse a string to RGBA color value.
 *
 ...
 *
 * @param color The RGBA value. `Red`, `Green`, `Blue` as number in range [0..255],
 *              and `Alpha` as number in range [0..1].
 ...
 *
 * @param color  The HSLA value. `Hue` as degrees [0..360], `Saturation`
 *               and `Lightness` as number in range [0..1].
 * @return CSS color string.
 */
 ...
 *
 * @param color  The OKLCH value. `Lightness`, `Chroma` as number in range [0..1]
 *               and `Hue` as degrees [0..360].
 * @return CSS color string.
 */
